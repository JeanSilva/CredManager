...
public class ColaboradorCadastro extends javax.swing.JInternalFrame {
    ...
    private void atualizarColaborador(Rm_Colaborador colaborador) {
        ...
        if (colaborador.getPermissaoUsuario() == null) {
            colaborador.setPermissaoUsuario(CriarPermissao(colaborador));
        } else {
            colaborador.getPermissaoUsuario().setCadastro(cadastros.isSelected());
    ...
    private void salvarColaborador() {
        ...
        //Criar Permissoes
        NovoColaborador.setPermissaoUsuario(CriarPermissao(NovoColaborador));
    ...
    public Rm_PermissaoUsuario CriarPermissao(Rm_Colaborador colaborador) {
