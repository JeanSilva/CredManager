 ...
 * @author DEV
 */
public class RelatorioGanho extends javax.swing.JInternalFrame {
    ...
    public RelatorioGanho(Rm_Colaborador colaborador) {
        initComponents();
        jListColaborador.setVisible(false);
        modelo = new DefaultListModel();
        jListColaborador.setModel(modelo);
        ...
        if(!colaborador.getPermissaoUsuario().isGanhos()){
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if ((e.getButton() == MouseEvent.BUTTON1) && (e.getClickCount() == 2)) {
                        try {
                            ...
                            Logger.getLogger(RelatorioGanho.class.getName()).log(Level.SEVERE, null, ex);
                        }
        ...
        jPanelAbertasLayout.setVerticalGroup(
            ...
            .addGroup(jPanelAbertasLayout.createSequentialGroup()
                ...
                .addGroup(jPanelAbertasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPaneParcelasAbertas, javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanelAtrasadasLayout.setVerticalGroup(
            ...
            .addGroup(jPanelAtrasadasLayout.createSequentialGroup()
                ...
                .addGroup(jPanelAtrasadasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPaneParcelasAtrasadas, javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE))
                .addGap(6, 6, 6))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, 0)
                        .addComponent(jListColaborador, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTabbedPaneEmprestimo, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE)
